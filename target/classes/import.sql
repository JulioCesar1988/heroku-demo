...
/* Adopciones */
INSERT INTO adopciones (id_adopcion, nombre, raza, tamanio, color, edad, genero, telefono, adoptado, fecha_adopcion, nombre_completo_adoptante, telefono_adoptante, email_adoptante, id_cliente, fecha_creacion, fecha_borrado) VALUES(1, 'Lluvia', 'Terrier', 'Pequeño','marron', '5 meses', 'Hembra', '2213456783', false, null, null, null, null, 5, now(), null);
INSERT INTO adopciones (id_adopcion, nombre, raza, tamanio, color, edad, genero, telefono, adoptado, fecha_adopcion, nombre_completo_adoptante, telefono_adoptante, email_adoptante, id_cliente, fecha_creacion, fecha_borrado) VALUES(2, 'Roque', 'Mestizo', 'Mediano','negro','9 meses', 'Macho', '2213456783', true, '2022-04-10', 'Daniel Perez', '2213456783', 'daniel.perez@gmail.com', 3, now(), null);
INSERT INTO adopciones (id_adopcion, nombre, raza, tamanio, color, edad, genero, telefono, adoptado, fecha_adopcion, nombre_completo_adoptante, telefono_adoptante, email_adoptante, id_cliente, fecha_creacion, fecha_borrado) VALUES(3, 'Simona', 'Caniche', 'Mediano','marrón','1 año', 'Hembra', '2213456783', true, '2022-04-10', 'Juliana Alvarez', '2213457383', 'juliana.alvarez@gmail.com', 3, now(), null);
INSERT INTO adopciones (id_adopcion, nombre, raza, tamanio, color, edad, genero, telefono, adoptado, fecha_adopcion, nombre_completo_adoptante, telefono_adoptante, email_adoptante, id_cliente, fecha_creacion, fecha_borrado) VALUES(4, 'Rocky', 'San Bernardo', 'Grande','marron con blanco','2 años', 'Macho', '2213456783', false, null, null, null, null, 3, now(), null);
INSERT INTO adopciones (id_adopcion, nombre, raza, tamanio, color, edad, genero, telefono, adoptado, fecha_adopcion, nombre_completo_adoptante, telefono_adoptante, email_adoptante, id_cliente, fecha_creacion, fecha_borrado) VALUES(5, 'Lucy', 'Mestizo', 'Mediano','marron con blanco','9 meses', 'Hembra', '2213456783', false, null, null, null, null, 3, now(), null);
INSERT INTO adopciones (id_adopcion, nombre, raza, tamanio, color, edad, genero, telefono, adoptado, fecha_adopcion, nombre_completo_adoptante, telefono_adoptante, email_adoptante, id_cliente, fecha_creacion, fecha_borrado) VALUES(6, 'Rochi', 'Mestizo', 'Mediano','marrón','10 meses', 'Hembra', '2213456783', true, '2022-04-10', 'Mariana Velez', '2213456783', 'mariana.velez@gmail.com', 4, now(), null);
INSERT INTO adopciones (id_adopcion, nombre, raza, tamanio, color, edad, genero, telefono, adoptado, fecha_adopcion, nombre_completo_adoptante, telefono_adoptante, email_adoptante, id_cliente, fecha_creacion, fecha_borrado) VALUES(7, 'Tito', 'Chihuahua', 'Pequeño','blanco con marron','1 año y medio', 'Macho', '2213456783', false, null, null, null, null, 5, now(), null);
INSERT INTO adopciones (id_adopcion, nombre, raza, tamanio, color, edad, genero, telefono, adoptado, fecha_adopcion, nombre_completo_adoptante, telefono_adoptante, email_adoptante, id_cliente, fecha_creacion, fecha_borrado) VALUES(8, 'Luna', 'Mestizo', 'Grande','blanco','1 año', 'Hembra', '2213456783', false, null, null, null, null, 4, now(), null);
